 ...
 */
@WebServlet("/MyOrdersheetList")
public class MyOrdersheetList extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(dto!=null) {
			...
			List<MyOrderSheetDTO> list = service.myordersheetList(userid);
			request.setAttribute("ordersheetList", list);
			nextPage = "myordersheetList.jsp";
